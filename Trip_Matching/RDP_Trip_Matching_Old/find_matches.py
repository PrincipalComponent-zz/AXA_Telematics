...
def compare_two_sets_of_angles(path1, path2):
    ...
    for cnt in xrange (0, len(path1.angles)):
       ...
       for cnt2 in xrange(np.searchsorted( angles2, angle1-angle_tolerance), np.searchsorted( angles2, angle1+angle_tolerance)):  # these are the locations with angles that match   
